...
Before you start, we expect that you are already familiar with concept of Germinate platform and its general purpose regarding COUSIN project targets. 

::: {.callout-tip}
If you are interested in a fully training on Germinate, an official training resource is available here: [https://germinateplatform.github.io/germinate-training/](https://germinateplatform.github.io/germinate-training/)
:::
...
<div style="display: flex; align-items: flex-start; gap: 20px;">
  ...
  <figure style="margin: 0; text-align: center;">
    ...
    <figcaption>Figure 6 - Left Menu, Data Resources</figcaption>
  </figure>
  ...
  <a href="https://cousin.ipk-gatersleben.de/templates" target="_blank" rel="noopener noreferrer">https://cousin.ipk-gatersleben.de/templates</a>
...
The purpose of this template is to record the passport data of ex situ accessions based on the Multi-Crop Passport Descriptor (MCPD) format. A separate template will soon be available for in situ material. The template has been adapted for the COUSIN project. For compatibility reasons with the underlying Germinate system, there are a number of additional fields for which default values have already been entered.
...
::: {.callout-note}
If you don't know how to classify the license for your data, the suggested one for COUSIN project is **Creative Commons Attribution 4.0 International Public License** (CC BY 4.0). This license allows anyone to use, share and adapt your data, but requires the attribution to you as original creator. 

<figure><img src="cc_by.png" alt="by" border="0" width="100"></figure>

For more details <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" rel="noopener noreferrer">read the license deed</a>.
:::
